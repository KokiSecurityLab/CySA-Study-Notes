...
### 2. STIX and TAXII-Based Indicator Sharing
...
### 3. Indicator Distribution and Node Quarantine
...
### 4. Feed Trust Requirements and Reintegration Review
...
* **自己修復およびベースライン統制との整合**: 分散ファイアウォールの構成を、テクニカルペーパーシリーズ #016 で定義した自動修復アプローチおよび テクニカルペーパーシリーズ #001 で定義したベースライン境界統制と突き合わせます。
