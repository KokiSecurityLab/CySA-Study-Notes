...
### 4. Least-Privilege Scoping and Segmentation
...
* **ベースライン境界統制との整合**: アイデンティティおよびアクセストークンを　テクニカルペーパーシリーズ #001　で定義されたベースライン境界統制と突き合わせ、アクセス統治をより広いセキュリティアーキテクチャと一貫させます。
