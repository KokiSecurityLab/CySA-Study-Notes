...
単なる理論の学習に留まらず、複雑化するデジタル領域全体の完全性と強固なレジリエンス（回復力）をアーキテクチャの根本から設計し、より安全で確固たる情報インフラ環境を社会に提供することをミッションとしています。現在、最高峰のセキュリティ資格であるCISSPの全セキュリティドメイン指標に直結した、次世代の先行防衛フレームワークを定常的に研究・モデリングしています。
